    ...
    makeTool(data) {
        ...
        return new tool_1.Tool({
            ...
            version: (typeof data.version === 'string')
                ? data.version
                : undefined,
            externalReferences: new externalReference_1.ExternalReferenceRepository(__classPrivateFieldGet(this, _ToolBuilder_extRefFactory, "f").makeExternalReferences(data))
        });
    }
}
